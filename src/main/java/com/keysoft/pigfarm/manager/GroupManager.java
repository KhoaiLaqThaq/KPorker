...
public class GroupManager {
	...
	public EntityResponse saveOrUpdate(GroupDto group) {
		ResponseEntity<?> response = restHelper.send(serviceProperties.getPaths().get(ApiEnum.PATH_GROUP_CREATE_OR_UPDATE.val), HttpMethod.POST, group, EntityResponse.class);
